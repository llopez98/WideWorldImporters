...
namespace WorldWideImporters.Purchasing.Context
{
    public partial class WideWorldImportersStandardContext : DbContext
    {
        public WideWorldImportersStandardContext()
        {
        }

        public WideWorldImportersStandardContext(DbContextOptions<WideWorldImportersStandardContext> options)
            : base(options)
        {
        }
